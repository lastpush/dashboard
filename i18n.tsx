...
const translations: Record<Locale, Record<string, string>> = {
  ...
  ru: {
    ...
    'billing.topup.placeorder': 'Оформить заказ',
    'billing.topup.qr': 'QR платежа',
    'billing.topup.confirm': 'Я оплатил',
    'billing.topup.confirming': 'Подтверждение...',
    'billing.topup.confirmcountdown': 'Перенаправление через {seconds}с',
    'billing.topup.ordercountdown': 'Осталось: {seconds}с. Заказ истечет по таймеру.',
    'billing.topup.copy': 'Копировать',
    'billing.topup.copied': 'Скопировано',
    'billing.topup.copyfailed': 'Ошибка копирования',
  ...
  fr: {
    ...
    'sites.deploy.logs': '>',
    'sites.deploy.building': 'Déploiement...',
    'sites.deploy.countdown': 'Redirection dans {seconds}s',
    ...
    'sites.detail.name': 'Nom',
    'sites.detail.domain': 'Domaine',
    'sites.detail.framework': 'Framework',
    'sites.detail.lastdeploy': 'Dernier déploiement',
    'sites.detail.deletesite': 'Supprimer le site',
    'sites.detail.deleteconfirm': 'Supprimer ce site ? Cette action est irréversible.',
    'sites.detail.deleting': 'Suppression...',
    'sites.detail.deletecountdown': 'Redirection dans {seconds}s',
    ...
    'billing.topup.loading': 'Création de la commande...',
    'billing.topup.deposit': 'Adresse : {address}',
    'billing.topup.token': 'Token',
    'billing.topup.tokenlabel': 'Token : {token}',
    'billing.topup.amount': 'Montant : ${amount}',
    'billing.topup.network': 'Réseau : {network}',
    'billing.topup.placeorder': 'Passer commande',
    'billing.topup.qr': 'QR de paiement',
    'billing.topup.confirm': 'J’ai payé',
    'billing.topup.confirming': 'Confirmation...',
    'billing.topup.confirmcountdown': 'Redirection dans {seconds}s',
    'billing.topup.ordercountdown': 'Temps restant : {seconds}s. La commande expirera.',
    'billing.topup.copy': 'Copier',
    'billing.topup.copied': 'Copié',
    'billing.topup.copyfailed': 'Copie échouée',
